...
SoftwareSerial simA800Serial(10, 11); // Chân TX và RX của ESP32-CAM
//
...
const char* ssid = "DuyManhKMA";//WIFI NAME
const char* password = "hDm30102001@!"; //WIFI PASSWORD
...
void loop() {
  ...
  takePhoto();
    ...
    delay(1000);
    simA800Serial.print("AT+CMGS=\"+84964888301\"\r"); // Số điện thoại nhận SMS
    delay(1000);
